...
// Your existing functions (getAllUsers, getUserById, createUser, updateUserById, deleteUserById)
...
export const logoutUser = (req, res) => {
  // To "log out" the user, you can simply return a message, as token invalidation
  // is typically handled client-side by removing the token.
  res.json({ message: "Logout successful" });
};

// Register (Create a new user) without hashing password
